...
from bmopso.util.dominance import find_non_dominated_constrained
...
class NonDominatedArchive:
    ...
    def update(
        ...
        random_state : np.random.Generator | None, default=None
            NumPy Generator forwarded to crowded-hypercube pruning.
        """
        if cv is None:
    ...
    def select_leaders(
        ...
        return self.grid.select_leaders(
            self._x, self._f, n_particles, random_state=random_state
        )
